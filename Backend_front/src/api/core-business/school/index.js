...
/** 获取学校平铺列表 */
export function fetchGetSchoolList(params) {
    return api.get({
...
/** 新增学校 */
export function fetchAddSchool(params) {
    return api.post({
...
/** 新增节点 */
export function fetchAddNode(params) {
...
/** 修改节点 */
export function fetchUpdateSchool(params) {
    return api.put({
...
/** 删除节点 */
export function fetchDeleteSchool(id) {
    return api.del({
        url: `/api/system/school/delete/${id}`
    });
}
/** 批量删除学校 */
export function fetchBatchDeleteSchools(ids) {
    return api.post({
...
/** 导入 Excel */
export function fetchImportExcel(file) {
