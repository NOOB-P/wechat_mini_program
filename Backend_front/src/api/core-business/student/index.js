...
/** 获取学生列表 */
export function fetchGetStudentList(params) {
    return api.get({
...
/** 新增学生 */
export function fetchAddStudent(params) {
    return api.post({
...
/** 更新学生 */
export function fetchUpdateStudent(params) {
    return api.put({
...
/** 删除学生 */
export function fetchDeleteStudent(id) {
    return api.del({
        url: `/api/students/delete/${id}`
    });
}
/** 批量删除学生 */
export function fetchBatchDeleteStudents(ids) {
    return api.post({
...
/** 获取学生绑定的家长手机号列表 */
export function fetchGetBoundParents(id) {
    return api.get({
        url: `/api/students/bound-parents/${id}`
    });
}
/** 批量开通 VIP/SVIP */
export function fetchBatchUpdateStatus(params) {
...
/** 导入学生 Excel */
export function fetchImportStudents(file, schoolId, classId) {
