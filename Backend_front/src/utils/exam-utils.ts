...
function parseChineseQuestionNumber(raw: string) {
...
function formatQuestionNo(no: number | null, fallback?: number) {
 ...
 */
export function normalizeQuestionNo(value?: string | number | null, fallback?: number) {
