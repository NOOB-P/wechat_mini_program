...
import { getCourseList, addCourse, updateCourse, deleteCourse, changeCourseStatus, getEpisodeList, addEpisode, updateEpisode, deleteEpisode, getVideoList, addVideo, updateVideo, deleteVideo } from '@/api/course-study/course/index';
...
function __VLS_template() {
    ...
    if (!__VLS_ctx.showDetail && !__VLS_ctx.showEpisodeManagement) {
        ...
        /** @type { [typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, ] } */
        // @ts-ignore
        const __VLS_91 = __VLS_asFunctionalComponent(__VLS_90, new __VLS_90({ prop: ("type"), label: ("类型"), }));
        const __VLS_92 = __VLS_91({ prop: ("type"), label: ("类型"), }, ...__VLS_functionalComponentArgsRest(__VLS_91));
        __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
        {
        ...
        /** @type { [typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, ] } */
        // @ts-ignore
        const __VLS_139 = __VLS_asFunctionalComponent(__VLS_138, new __VLS_138({ prop: ("isSvipOnly"), label: ("SVIP"), width: ("80"), }));
        const __VLS_140 = __VLS_139({ prop: ("isSvipOnly"), label: ("SVIP"), width: ("80"), }, ...__VLS_functionalComponentArgsRest(__VLS_139));
        __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
        {
            const { default: __VLS_thisSlot } = __VLS_nonNullable(__VLS_143.slots);
            const [{ row }] = __VLS_getSlotParams(__VLS_thisSlot);
            const __VLS_144 = __VLS_resolvedLocalAndGlobalComponents.ElTag;
            /** @type { [typeof __VLS_components.ElTag, typeof __VLS_components.elTag, typeof __VLS_components.ElTag, typeof __VLS_components.elTag, ] } */
            // @ts-ignore
            const __VLS_145 = __VLS_asFunctionalComponent(__VLS_144, new __VLS_144({ type: ((row.isSvipOnly ? 'danger' : 'info')), size: ("small"), }));
            const __VLS_146 = __VLS_145({ type: ((row.isSvipOnly ? 'danger' : 'info')), size: ("small"), }, ...__VLS_functionalComponentArgsRest(__VLS_145));
            (row.isSvipOnly ? '是' : '否');
        ...
        /** @type { [typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, ] } */
        // @ts-ignore
        const __VLS_151 = __VLS_asFunctionalComponent(__VLS_150, new __VLS_150({ label: ("封面"), width: ("120"), }));
        const __VLS_152 = __VLS_151({ label: ("封面"), width: ("120"), }, ...__VLS_functionalComponentArgsRest(__VLS_151));
        __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
        {
            const { default: __VLS_thisSlot } = __VLS_nonNullable(__VLS_155.slots);
            const [{ row }] = __VLS_getSlotParams(__VLS_thisSlot);
            const __VLS_156 = __VLS_resolvedLocalAndGlobalComponents.ElImage;
            /** @type { [typeof __VLS_components.ElImage, typeof __VLS_components.elImage, ] } */
            // @ts-ignore
            const __VLS_157 = __VLS_asFunctionalComponent(__VLS_156, new __VLS_156({ src: ((row.cover)), ...{ class: ("w-20 h-12 rounded") }, fit: ("cover"), }));
            const __VLS_158 = __VLS_157({ src: ((row.cover)), ...{ class: ("w-20 h-12 rounded") }, fit: ("cover"), }, ...__VLS_functionalComponentArgsRest(__VLS_157));
        }
        var __VLS_155;
        const __VLS_162 = __VLS_resolvedLocalAndGlobalComponents.ElTableColumn;
        /** @type { [typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, ] } */
        // @ts-ignore
        const __VLS_163 = __VLS_asFunctionalComponent(__VLS_162, new __VLS_162({ prop: ("isRecommend"), label: ("今日推荐"), width: ("100"), }));
        const __VLS_164 = __VLS_163({ prop: ("isRecommend"), label: ("今日推荐"), width: ("100"), }, ...__VLS_functionalComponentArgsRest(__VLS_163));
        __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
        {
            ...
            /** @type { [typeof __VLS_components.ElTag, typeof __VLS_components.elTag, typeof __VLS_components.ElTag, typeof __VLS_components.elTag, ] } */
            // @ts-ignore
            const __VLS_169 = __VLS_asFunctionalComponent(__VLS_168, new __VLS_168({ type: ((row.isRecommend === 1 ? 'success' : 'info')), }));
            const __VLS_170 = __VLS_169({ type: ((row.isRecommend === 1 ? 'success' : 'info')), }, ...__VLS_functionalComponentArgsRest(__VLS_169));
        ...
        /** @type { [typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, ] } */
        // @ts-ignore
        const __VLS_175 = __VLS_asFunctionalComponent(__VLS_174, new __VLS_174({ prop: ("status"), label: ("状态"), width: ("100"), }));
        const __VLS_176 = __VLS_175({ prop: ("status"), label: ("状态"), width: ("100"), }, ...__VLS_functionalComponentArgsRest(__VLS_175));
        __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
        {
            const { default: __VLS_thisSlot } = __VLS_nonNullable(__VLS_179.slots);
            const [{ row }] = __VLS_getSlotParams(__VLS_thisSlot);
            const __VLS_180 = __VLS_resolvedLocalAndGlobalComponents.ElTag;
            /** @type { [typeof __VLS_components.ElTag, typeof __VLS_components.elTag, typeof __VLS_components.ElTag, typeof __VLS_components.elTag, ] } */
            // @ts-ignore
            const __VLS_181 = __VLS_asFunctionalComponent(__VLS_180, new __VLS_180({ type: ((row.status === 1 ? 'success' : 'info')), }));
            const __VLS_182 = __VLS_181({ type: ((row.status === 1 ? 'success' : 'info')), }, ...__VLS_functionalComponentArgsRest(__VLS_181));
            (row.status === 1 ? '已上架' : '已下架');
            __VLS_nonNullable(__VLS_185.slots).default;
            var __VLS_185;
        }
        var __VLS_179;
        const __VLS_186 = __VLS_resolvedLocalAndGlobalComponents.ElTableColumn;
        /** @type { [typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, ] } */
        // @ts-ignore
        const __VLS_187 = __VLS_asFunctionalComponent(__VLS_186, new __VLS_186({ prop: ("createTime"), label: ("创建时间"), width: ("180"), }));
        const __VLS_188 = __VLS_187({ prop: ("createTime"), label: ("创建时间"), width: ("180"), }, ...__VLS_functionalComponentArgsRest(__VLS_187));
        const __VLS_192 = __VLS_resolvedLocalAndGlobalComponents.ElTableColumn;
        /** @type { [typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, ] } */
        // @ts-ignore
        const __VLS_193 = __VLS_asFunctionalComponent(__VLS_192, new __VLS_192({ label: ("操作"), width: ("280"), fixed: ("right"), }));
        const __VLS_194 = __VLS_193({ label: ("操作"), width: ("280"), fixed: ("right"), }, ...__VLS_functionalComponentArgsRest(__VLS_193));
        __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
        {
            const { default: __VLS_thisSlot } = __VLS_nonNullable(__VLS_197.slots);
            const [{ row }] = __VLS_getSlotParams(__VLS_thisSlot);
            const __VLS_198 = __VLS_resolvedLocalAndGlobalComponents.ElButton;
            /** @type { [typeof __VLS_components.ElButton, typeof __VLS_components.elButton, typeof __VLS_components.ElButton, typeof __VLS_components.elButton, ] } */
            // @ts-ignore
            const __VLS_199 = __VLS_asFunctionalComponent(__VLS_198, new __VLS_198({ ...{ 'onClick': {} }, link: (true), type: ("primary"), }));
            const __VLS_200 = __VLS_199({ ...{ 'onClick': {} }, link: (true), type: ("primary"), }, ...__VLS_functionalComponentArgsRest(__VLS_199));
            let __VLS_204;
            const __VLS_205 = {
                onClick: (...[$event]) => {
                    if (!(!((!__VLS_ctx.showDetail && !__VLS_ctx.showEpisodeManagement))))
            ...
            /** @type { [typeof __VLS_components.ElButton, typeof __VLS_components.elButton, typeof __VLS_components.ElButton, typeof __VLS_components.elButton, ] } */
            // @ts-ignore
            const __VLS_207 = __VLS_asFunctionalComponent(__VLS_206, new __VLS_206({ ...{ 'onClick': {} }, link: (true), type: ("primary"), }));
            const __VLS_208 = __VLS_207({ ...{ 'onClick': {} }, link: (true), type: ("primary"), }, ...__VLS_functionalComponentArgsRest(__VLS_207));
            let __VLS_212;
            const __VLS_213 = {
                onClick: (...[$event]) => {
                    if (!(!((!__VLS_ctx.showDetail && !__VLS_ctx.showEpisodeManagement))))
            ...
            /** @type { [typeof __VLS_components.ElButton, typeof __VLS_components.elButton, typeof __VLS_components.ElButton, typeof __VLS_components.elButton, ] } */
            // @ts-ignore
            const __VLS_215 = __VLS_asFunctionalComponent(__VLS_214, new __VLS_214({ ...{ 'onClick': {} }, link: (true), type: ((row.status === 1 ? 'warning' : 'success')), }));
            const __VLS_216 = __VLS_215({ ...{ 'onClick': {} }, link: (true), type: ((row.status === 1 ? 'warning' : 'success')), }, ...__VLS_functionalComponentArgsRest(__VLS_215));
            let __VLS_220;
            const __VLS_221 = {
                onClick: (...[$event]) => {
                    if (!(!((!__VLS_ctx.showDetail && !__VLS_ctx.showEpisodeManagement))))
            ...
            /** @type { [typeof __VLS_components.ElButton, typeof __VLS_components.elButton, typeof __VLS_components.ElButton, typeof __VLS_components.elButton, ] } */
            // @ts-ignore
            const __VLS_223 = __VLS_asFunctionalComponent(__VLS_222, new __VLS_222({ ...{ 'onClick': {} }, link: (true), type: ("danger"), }));
            const __VLS_224 = __VLS_223({ ...{ 'onClick': {} }, link: (true), type: ("danger"), }, ...__VLS_functionalComponentArgsRest(__VLS_223));
            let __VLS_228;
            const __VLS_229 = {
                onClick: (...[$event]) => {
                    if (!(!((!__VLS_ctx.showDetail && !__VLS_ctx.showEpisodeManagement))))
        ...
        __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
        const __VLS_230 = __VLS_resolvedLocalAndGlobalComponents.ElCard;
        /** @type { [typeof __VLS_components.ElCard, typeof __VLS_components.elCard, typeof __VLS_components.ElCard, typeof __VLS_components.elCard, ] } */
        // @ts-ignore
        const __VLS_231 = __VLS_asFunctionalComponent(__VLS_230, new __VLS_230({ shadow: ("never"), }));
        const __VLS_232 = __VLS_231({ shadow: ("never"), }, ...__VLS_functionalComponentArgsRest(__VLS_231));
        __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
        {
            const { header: __VLS_thisSlot } = __VLS_nonNullable(__VLS_235.slots);
            __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("flex justify-between items-center") }, });
            __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("flex items-center") }, });
            const __VLS_236 = __VLS_resolvedLocalAndGlobalComponents.ElButton;
            /** @type { [typeof __VLS_components.ElButton, typeof __VLS_components.elButton, typeof __VLS_components.ElButton, typeof __VLS_components.elButton, ] } */
            // @ts-ignore
            const __VLS_237 = __VLS_asFunctionalComponent(__VLS_236, new __VLS_236({ ...{ 'onClick': {} }, link: (true), }));
            const __VLS_238 = __VLS_237({ ...{ 'onClick': {} }, link: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_237));
            let __VLS_242;
            const __VLS_243 = {
                onClick: (...[$event]) => {
                    if (!(!((!__VLS_ctx.showDetail && !__VLS_ctx.showEpisodeManagement))))
            ...
            let __VLS_239;
            let __VLS_240;
            const __VLS_244 = __VLS_resolvedLocalAndGlobalComponents.ElIcon;
            /** @type { [typeof __VLS_components.ElIcon, typeof __VLS_components.elIcon, typeof __VLS_components.ElIcon, typeof __VLS_components.elIcon, ] } */
            // @ts-ignore
            const __VLS_245 = __VLS_asFunctionalComponent(__VLS_244, new __VLS_244({}));
            const __VLS_246 = __VLS_245({}, ...__VLS_functionalComponentArgsRest(__VLS_245));
            const __VLS_250 = __VLS_resolvedLocalAndGlobalComponents.ArrowLeft;
            /** @type { [typeof __VLS_components.ArrowLeft, ] } */
            // @ts-ignore
            ...
            /** @type { [typeof __VLS_components.ElButton, typeof __VLS_components.elButton, typeof __VLS_components.ElButton, typeof __VLS_components.elButton, ] } */
            // @ts-ignore
            const __VLS_257 = __VLS_asFunctionalComponent(__VLS_256, new __VLS_256({ ...{ 'onClick': {} }, type: ("primary"), }));
            const __VLS_258 = __VLS_257({ ...{ 'onClick': {} }, type: ("primary"), }, ...__VLS_functionalComponentArgsRest(__VLS_257));
            let __VLS_262;
            const __VLS_263 = {
        ...
        const __VLS_264 = __VLS_resolvedLocalAndGlobalComponents.ElTable;
        /** @type { [typeof __VLS_components.ElTable, typeof __VLS_components.elTable, typeof __VLS_components.ElTable, typeof __VLS_components.elTable, ] } */
        // @ts-ignore
        const __VLS_265 = __VLS_asFunctionalComponent(__VLS_264, new __VLS_264({ data: ((__VLS_ctx.episodeData)), border: (true), }));
        const __VLS_266 = __VLS_265({ data: ((__VLS_ctx.episodeData)), border: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_265));
        ...
        /** @type { [typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, ] } */
        // @ts-ignore
        const __VLS_271 = __VLS_asFunctionalComponent(__VLS_270, new __VLS_270({ type: ("index"), label: ("序号"), width: ("60"), }));
        const __VLS_272 = __VLS_271({ type: ("index"), label: ("序号"), width: ("60"), }, ...__VLS_functionalComponentArgsRest(__VLS_271));
        const __VLS_276 = __VLS_resolvedLocalAndGlobalComponents.ElTableColumn;
        /** @type { [typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, ] } */
        // @ts-ignore
        const __VLS_277 = __VLS_asFunctionalComponent(__VLS_276, new __VLS_276({ prop: ("title"), label: ("章节名称"), minWidth: ("200"), }));
        const __VLS_278 = __VLS_277({ prop: ("title"), label: ("章节名称"), minWidth: ("200"), }, ...__VLS_functionalComponentArgsRest(__VLS_277));
        const __VLS_282 = __VLS_resolvedLocalAndGlobalComponents.ElTableColumn;
        /** @type { [typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, ] } */
        // @ts-ignore
        const __VLS_283 = __VLS_asFunctionalComponent(__VLS_282, new __VLS_282({ prop: ("videoUrl"), label: ("视频地址"), minWidth: ("250"), showOverflowTooltip: (true), }));
        const __VLS_284 = __VLS_283({ prop: ("videoUrl"), label: ("视频地址"), minWidth: ("250"), showOverflowTooltip: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_283));
        __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
        {
            const { default: __VLS_thisSlot } = __VLS_nonNullable(__VLS_287.slots);
            const [{ row }] = __VLS_getSlotParams(__VLS_thisSlot);
            if (row.videoUrl) {
                const __VLS_288 = __VLS_resolvedLocalAndGlobalComponents.ElTag;
                /** @type { [typeof __VLS_components.ElTag, typeof __VLS_components.elTag, typeof __VLS_components.ElTag, typeof __VLS_components.elTag, ] } */
                // @ts-ignore
                const __VLS_289 = __VLS_asFunctionalComponent(__VLS_288, new __VLS_288({ type: ("success"), size: ("small"), }));
                const __VLS_290 = __VLS_289({ type: ("success"), size: ("small"), }, ...__VLS_functionalComponentArgsRest(__VLS_289));
                __VLS_nonNullable(__VLS_293.slots).default;
                var __VLS_293;
            }
            else {
                const __VLS_294 = __VLS_resolvedLocalAndGlobalComponents.ElTag;
                /** @type { [typeof __VLS_components.ElTag, typeof __VLS_components.elTag, typeof __VLS_components.ElTag, typeof __VLS_components.elTag, ] } */
                // @ts-ignore
                const __VLS_295 = __VLS_asFunctionalComponent(__VLS_294, new __VLS_294({ type: ("info"), size: ("small"), }));
                const __VLS_296 = __VLS_295({ type: ("info"), size: ("small"), }, ...__VLS_functionalComponentArgsRest(__VLS_295));
        ...
        var __VLS_287;
        const __VLS_300 = __VLS_resolvedLocalAndGlobalComponents.ElTableColumn;
        /** @type { [typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, ] } */
        // @ts-ignore
        const __VLS_301 = __VLS_asFunctionalComponent(__VLS_300, new __VLS_300({ prop: ("sortOrder"), label: ("排序"), width: ("80"), }));
        const __VLS_302 = __VLS_301({ prop: ("sortOrder"), label: ("排序"), width: ("80"), }, ...__VLS_functionalComponentArgsRest(__VLS_301));
        const __VLS_306 = __VLS_resolvedLocalAndGlobalComponents.ElTableColumn;
        /** @type { [typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, ] } */
        // @ts-ignore
        const __VLS_307 = __VLS_asFunctionalComponent(__VLS_306, new __VLS_306({ label: ("操作"), width: ("220"), fixed: ("right"), }));
        const __VLS_308 = __VLS_307({ label: ("操作"), width: ("220"), fixed: ("right"), }, ...__VLS_functionalComponentArgsRest(__VLS_307));
        __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
        {
            const { default: __VLS_thisSlot } = __VLS_nonNullable(__VLS_311.slots);
            const [{ row }] = __VLS_getSlotParams(__VLS_thisSlot);
            const __VLS_312 = __VLS_resolvedLocalAndGlobalComponents.ElButton;
            /** @type { [typeof __VLS_components.ElButton, typeof __VLS_components.elButton, typeof __VLS_components.ElButton, typeof __VLS_components.elButton, ] } */
            // @ts-ignore
            const __VLS_313 = __VLS_asFunctionalComponent(__VLS_312, new __VLS_312({ ...{ 'onClick': {} }, link: (true), type: ("primary"), }));
            const __VLS_314 = __VLS_313({ ...{ 'onClick': {} }, link: (true), type: ("primary"), }, ...__VLS_functionalComponentArgsRest(__VLS_313));
            let __VLS_318;
            const __VLS_319 = {
                onClick: (...[$event]) => {
                    if (!(!((!__VLS_ctx.showDetail && !__VLS_ctx.showEpisodeManagement))))
            ...
            var __VLS_317;
            const __VLS_320 = __VLS_resolvedLocalAndGlobalComponents.ElButton;
            /** @type { [typeof __VLS_components.ElButton, typeof __VLS_components.elButton, typeof __VLS_components.ElButton, typeof __VLS_components.elButton, ] } */
            // @ts-ignore
            const __VLS_321 = __VLS_asFunctionalComponent(__VLS_320, new __VLS_320({ ...{ 'onClick': {} }, link: (true), type: ("primary"), }));
            const __VLS_322 = __VLS_321({ ...{ 'onClick': {} }, link: (true), type: ("primary"), }, ...__VLS_functionalComponentArgsRest(__VLS_321));
            let __VLS_326;
            const __VLS_327 = {
                onClick: (...[$event]) => {
                    if (!(!((!__VLS_ctx.showDetail && !__VLS_ctx.showEpisodeManagement))))
                    ...
                    if (!((__VLS_ctx.showEpisodeManagement && !__VLS_ctx.showEpisodeVideoManagement)))
                        return;
                    __VLS_ctx.handleEditEpisode(row);
                }
            };
            let __VLS_323;
            let __VLS_324;
            ...
            /** @type { [typeof __VLS_components.ElButton, typeof __VLS_components.elButton, typeof __VLS_components.ElButton, typeof __VLS_components.elButton, ] } */
            // @ts-ignore
            const __VLS_329 = __VLS_asFunctionalComponent(__VLS_328, new __VLS_328({ ...{ 'onClick': {} }, link: (true), type: ("danger"), }));
            const __VLS_330 = __VLS_329({ ...{ 'onClick': {} }, link: (true), type: ("danger"), }, ...__VLS_functionalComponentArgsRest(__VLS_329));
            let __VLS_334;
            const __VLS_335 = {
                onClick: (...[$event]) => {
                    if (!(!((!__VLS_ctx.showDetail && !__VLS_ctx.showEpisodeManagement))))
        ...
        __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
        const __VLS_336 = __VLS_resolvedLocalAndGlobalComponents.ElCard;
        /** @type { [typeof __VLS_components.ElCard, typeof __VLS_components.elCard, typeof __VLS_components.ElCard, typeof __VLS_components.elCard, ] } */
        // @ts-ignore
        const __VLS_337 = __VLS_asFunctionalComponent(__VLS_336, new __VLS_336({ shadow: ("never"), }));
        const __VLS_338 = __VLS_337({ shadow: ("never"), }, ...__VLS_functionalComponentArgsRest(__VLS_337));
        __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
        {
            const { header: __VLS_thisSlot } = __VLS_nonNullable(__VLS_341.slots);
            __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("flex justify-between items-center") }, });
            __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("flex items-center") }, });
            const __VLS_342 = __VLS_resolvedLocalAndGlobalComponents.ElButton;
            /** @type { [typeof __VLS_components.ElButton, typeof __VLS_components.elButton, typeof __VLS_components.ElButton, typeof __VLS_components.elButton, ] } */
            // @ts-ignore
            const __VLS_343 = __VLS_asFunctionalComponent(__VLS_342, new __VLS_342({ ...{ 'onClick': {} }, link: (true), }));
            const __VLS_344 = __VLS_343({ ...{ 'onClick': {} }, link: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_343));
            let __VLS_348;
            const __VLS_349 = {
                onClick: (...[$event]) => {
                    if (!(!((!__VLS_ctx.showDetail && !__VLS_ctx.showEpisodeManagement))))
            ...
            let __VLS_345;
            let __VLS_346;
            const __VLS_350 = __VLS_resolvedLocalAndGlobalComponents.ElIcon;
            /** @type { [typeof __VLS_components.ElIcon, typeof __VLS_components.elIcon, typeof __VLS_components.ElIcon, typeof __VLS_components.elIcon, ] } */
            // @ts-ignore
            ...
            const __VLS_356 = __VLS_resolvedLocalAndGlobalComponents.ArrowLeft;
            /** @type { [typeof __VLS_components.ArrowLeft, ] } */
            // @ts-ignore
            ...
            const __VLS_362 = __VLS_resolvedLocalAndGlobalComponents.ElButton;
            /** @type { [typeof __VLS_components.ElButton, typeof __VLS_components.elButton, typeof __VLS_components.ElButton, typeof __VLS_components.elButton, ] } */
            // @ts-ignore
            const __VLS_363 = __VLS_asFunctionalComponent(__VLS_362, new __VLS_362({ ...{ 'onClick': {} }, type: ("primary"), }));
            const __VLS_364 = __VLS_363({ ...{ 'onClick': {} }, type: ("primary"), }, ...__VLS_functionalComponentArgsRest(__VLS_363));
            let __VLS_368;
            const __VLS_369 = {
        ...
        const __VLS_370 = __VLS_resolvedLocalAndGlobalComponents.ElTable;
        /** @type { [typeof __VLS_components.ElTable, typeof __VLS_components.elTable, typeof __VLS_components.ElTable, typeof __VLS_components.elTable, ] } */
        // @ts-ignore
        const __VLS_371 = __VLS_asFunctionalComponent(__VLS_370, new __VLS_370({ data: ((__VLS_ctx.videoData)), border: (true), }));
        const __VLS_372 = __VLS_371({ data: ((__VLS_ctx.videoData)), border: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_371));
        ...
        const __VLS_376 = __VLS_resolvedLocalAndGlobalComponents.ElTableColumn;
        /** @type { [typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, ] } */
        // @ts-ignore
        const __VLS_377 = __VLS_asFunctionalComponent(__VLS_376, new __VLS_376({ type: ("index"), label: ("序号"), width: ("60"), }));
        const __VLS_378 = __VLS_377({ type: ("index"), label: ("序号"), width: ("60"), }, ...__VLS_functionalComponentArgsRest(__VLS_377));
        const __VLS_382 = __VLS_resolvedLocalAndGlobalComponents.ElTableColumn;
        /** @type { [typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, ] } */
        // @ts-ignore
        const __VLS_383 = __VLS_asFunctionalComponent(__VLS_382, new __VLS_382({ prop: ("title"), label: ("视频名称"), minWidth: ("200"), }));
        const __VLS_384 = __VLS_383({ prop: ("title"), label: ("视频名称"), minWidth: ("200"), }, ...__VLS_functionalComponentArgsRest(__VLS_383));
        const __VLS_388 = __VLS_resolvedLocalAndGlobalComponents.ElTableColumn;
        /** @type { [typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, ] } */
        // @ts-ignore
        const __VLS_389 = __VLS_asFunctionalComponent(__VLS_388, new __VLS_388({ prop: ("videoUrl"), label: ("视频地址"), minWidth: ("300"), showOverflowTooltip: (true), }));
        const __VLS_390 = __VLS_389({ prop: ("videoUrl"), label: ("视频地址"), minWidth: ("300"), showOverflowTooltip: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_389));
        __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
        {
            const { default: __VLS_thisSlot } = __VLS_nonNullable(__VLS_393.slots);
            const [{ row }] = __VLS_getSlotParams(__VLS_thisSlot);
            __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("flex items-center") }, });
            const __VLS_394 = __VLS_resolvedLocalAndGlobalComponents.ElIcon;
            /** @type { [typeof __VLS_components.ElIcon, typeof __VLS_components.elIcon, typeof __VLS_components.ElIcon, typeof __VLS_components.elIcon, ] } */
            // @ts-ignore
            const __VLS_395 = __VLS_asFunctionalComponent(__VLS_394, new __VLS_394({ ...{ class: ("text-green-500 mr-1") }, }));
            const __VLS_396 = __VLS_395({ ...{ class: ("text-green-500 mr-1") }, }, ...__VLS_functionalComponentArgsRest(__VLS_395));
            const __VLS_400 = __VLS_resolvedLocalAndGlobalComponents.VideoPlay;
        ...
        /** @type { [typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, ] } */
        // @ts-ignore
        const __VLS_407 = __VLS_asFunctionalComponent(__VLS_406, new __VLS_406({ prop: ("sortOrder"), label: ("排序"), width: ("80"), }));
        const __VLS_408 = __VLS_407({ prop: ("sortOrder"), label: ("排序"), width: ("80"), }, ...__VLS_functionalComponentArgsRest(__VLS_407));
        const __VLS_412 = __VLS_resolvedLocalAndGlobalComponents.ElTableColumn;
        /** @type { [typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, typeof __VLS_components.ElTableColumn, typeof __VLS_components.elTableColumn, ] } */
        // @ts-ignore
        const __VLS_413 = __VLS_asFunctionalComponent(__VLS_412, new __VLS_412({ label: ("操作"), width: ("150"), fixed: ("right"), }));
        const __VLS_414 = __VLS_413({ label: ("操作"), width: ("150"), fixed: ("right"), }, ...__VLS_functionalComponentArgsRest(__VLS_413));
        __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
        {
            const { default: __VLS_thisSlot } = __VLS_nonNullable(__VLS_417.slots);
            const [{ row }] = __VLS_getSlotParams(__VLS_thisSlot);
            const __VLS_418 = __VLS_resolvedLocalAndGlobalComponents.ElButton;
            /** @type { [typeof __VLS_components.ElButton, typeof __VLS_components.elButton, typeof __VLS_components.ElButton, typeof __VLS_components.elButton, ] } */
            // @ts-ignore
            const __VLS_419 = __VLS_asFunctionalComponent(__VLS_418, new __VLS_418({ ...{ 'onClick': {} }, link: (true), type: ("primary"), }));
            const __VLS_420 = __VLS_419({ ...{ 'onClick': {} }, link: (true), type: ("primary"), }, ...__VLS_functionalComponentArgsRest(__VLS_419));
            let __VLS_424;
            const __VLS_425 = {
                onClick: (...[$event]) => {
                    if (!(!((!__VLS_ctx.showDetail && !__VLS_ctx.showEpisodeManagement))))
            ...
            var __VLS_423;
            const __VLS_426 = __VLS_resolvedLocalAndGlobalComponents.ElButton;
            /** @type { [typeof __VLS_components.ElButton, typeof __VLS_components.elButton, typeof __VLS_components.ElButton, typeof __VLS_components.elButton, ] } */
            // @ts-ignore
            const __VLS_427 = __VLS_asFunctionalComponent(__VLS_426, new __VLS_426({ ...{ 'onClick': {} }, link: (true), type: ("danger"), }));
            const __VLS_428 = __VLS_427({ ...{ 'onClick': {} }, link: (true), type: ("danger"), }, ...__VLS_functionalComponentArgsRest(__VLS_427));
            let __VLS_432;
            const __VLS_433 = {
                onClick: (...[$event]) => {
                    if (!(!((!__VLS_ctx.showDetail && !__VLS_ctx.showEpisodeManagement))))
    ...
    [CourseDialog,];
    // @ts-ignore
    const __VLS_434 = __VLS_asFunctionalComponent(CourseDialog, new CourseDialog({ ...{ 'onSuccess': {} }, visible: ((__VLS_ctx.dialogVisible)), isEdit: ((__VLS_ctx.isEdit)), data: ((__VLS_ctx.editData)), }));
    const __VLS_435 = __VLS_434({ ...{ 'onSuccess': {} }, visible: ((__VLS_ctx.dialogVisible)), isEdit: ((__VLS_ctx.isEdit)), data: ((__VLS_ctx.editData)), }, ...__VLS_functionalComponentArgsRest(__VLS_434));
    let __VLS_439;
    const __VLS_440 = {
    ...
    [EpisodeDialog,];
    // @ts-ignore
    const __VLS_441 = __VLS_asFunctionalComponent(EpisodeDialog, new EpisodeDialog({ ...{ 'onSuccess': {} }, visible: ((__VLS_ctx.episodeDialogVisible)), isEdit: ((__VLS_ctx.isEpisodeEdit)), data: ((__VLS_ctx.episodeEditData)), courseId: ((__VLS_ctx.currentCourse?.id)), }));
    const __VLS_442 = __VLS_441({ ...{ 'onSuccess': {} }, visible: ((__VLS_ctx.episodeDialogVisible)), isEdit: ((__VLS_ctx.isEpisodeEdit)), data: ((__VLS_ctx.episodeEditData)), courseId: ((__VLS_ctx.currentCourse?.id)), }, ...__VLS_functionalComponentArgsRest(__VLS_441));
    let __VLS_446;
    const __VLS_447 = {
    ...
    [VideoDialog,];
    // @ts-ignore
    const __VLS_448 = __VLS_asFunctionalComponent(VideoDialog, new VideoDialog({ ...{ 'onSuccess': {} }, visible: ((__VLS_ctx.videoDialogVisible)), isEdit: ((__VLS_ctx.isVideoEdit)), data: ((__VLS_ctx.videoEditData)), episodeId: ((__VLS_ctx.currentEpisode?.id)), }));
    const __VLS_449 = __VLS_448({ ...{ 'onSuccess': {} }, visible: ((__VLS_ctx.videoDialogVisible)), isEdit: ((__VLS_ctx.isVideoEdit)), data: ((__VLS_ctx.videoEditData)), episodeId: ((__VLS_ctx.currentEpisode?.id)), }, ...__VLS_functionalComponentArgsRest(__VLS_448));
    let __VLS_453;
    const __VLS_454 = {
