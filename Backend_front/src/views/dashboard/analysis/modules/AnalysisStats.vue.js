...
function __VLS_template() {
    ...
    var __VLS_6 = {};
    for (const [item, index] of __VLS_getVForSourceType((props.data))) {
        ...
        // @ts-ignore
        const __VLS_14 = __VLS_asFunctionalComponent(__VLS_13, new __VLS_13({ ...{ class: ("text-[26px] font-medium mt-2") }, target: ((item.value)), duration: ((1300)), decimals: ((item.unit === '%' ? 1 : 0)), }));
        const __VLS_15 = __VLS_14({ ...{ class: ("text-[26px] font-medium mt-2") }, target: ((item.value)), duration: ((1300)), decimals: ((item.unit === '%' ? 1 : 0)), }, ...__VLS_functionalComponentArgsRest(__VLS_14));
        ...
        __VLS_elementAsFunction(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({ ...{ class: ("ml-1 text-xs font-semibold") }, ...{ class: (([item.trend === 'down' ? 'text-danger' : 'text-success'])) }, });
        (item.trend === 'up' ? '+' : '-');
        (item.percentage);
        ...
        // @ts-ignore
        const __VLS_20 = __VLS_asFunctionalComponent(__VLS_19, new __VLS_19({ icon: ((__VLS_ctx.getIcon(item.icon))), ...{ class: ("text-xl text-theme") }, }));
        const __VLS_21 = __VLS_20({ icon: ((__VLS_ctx.getIcon(item.icon))), ...{ class: ("text-xl text-theme") }, }, ...__VLS_functionalComponentArgsRest(__VLS_20));
...
//# sourceMappingURL=AnalysisStats.vue.js.map