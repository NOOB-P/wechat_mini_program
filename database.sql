...
-- 2. 统一账号表数据
INSERT INTO `sys_accounts` (`uid`, `username`, `nickname`, `password`, `phone`, `email`, `role_id`, `is_vip`, `is_svip`, `online_status`, `is_bound_student`, `is_enabled`) VALUES
(1, 'admin', '超级管理员', '123456', '13800000000', 'admin@example.com', 1, NULL, NULL, 'offline', 0, 1),
(2, 'manager', '运营人员', '123456', '13800000001', 'manager@example.com', 2, NULL, NULL, 'offline', 0, 1),
(3, 'parent01', '张三爸爸', '123456', '13800000002', 'parent01@example.com', 3, 1, 0, 'offline', 1, 1),
(4, 'parent02', '李四妈妈', '123456', '13800000003', 'parent02@example.com', 3, 0, 0, 'offline', 1, 1),
(5, 'parent03', '王五妈妈', '123456', '13800000004', 'parent03@example.com', 3, 1, 1, 'offline', 1, 1),
(6, 'parent04', '赵六爸爸', '123456', '13800000005', 'parent04@example.com', 3, 0, 0, 'offline', 1, 1),
(7, 'manager02', '财务人员', '123456', '13800000006', 'finance@example.com', 2, NULL, NULL, 'offline', 0, 1),
(8, 'parent05', '孙七妈妈', '123456', '13800000007', 'parent05@example.com', 3, 1, 0, 'offline', 1, 1),
(9, 'parent06', '周八爸爸', '123456', '13800000008', 'parent06@example.com', 3, 0, 0, 'offline', 1, 1),
(10, 'parent07', '吴九妈妈', '123456', '13800000009', 'parent07@example.com', 3, 1, 1, 'offline', 1, 1);
...
('CRS003', '小学英语启蒙课', 'https://example.com/cover3.jpg', 'https://example.com/video3.mp4', '<p>英语启蒙...</p>', 1, 0.00, 0),
('CRS004', '高中化学难点解析', 'https://example.com/cover4.jpg', 'https://example.com/video4.mp4', '<p>化学难点...</p>', 1, 199.00, 1),
('CRS005', '初中生物实验视频', 'https://example.com/cover5.jpg', 'https://example.com/video5.mp4', '<p>生物实验...</p>', 1, 0.00, 0);
